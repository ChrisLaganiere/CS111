 ...
 *
 *   Set the current process to have p_priority priority.
 *
 *****************************************************************************/
 ...
 * proc_share(share)
 *
 *   Set the current process to have p_share share.
 *
 *****************************************************************************/

static inline void
proc_share(int share)
{
	asm volatile("int %0\n"
		     : : "i" (INT_SYS_USER2),
		         "b" (share)
...
/*****************************************************************************
 * proc_print(character)
 *
 *   print the character supplied to cursorpos in a safe manner to avoid a race condition.
 *
 *****************************************************************************/

static inline void
proc_print(int character)
{
	asm volatile("int %0\n"
		     : : "i" (INT_SYS_USER3),
		         "b" (character)
